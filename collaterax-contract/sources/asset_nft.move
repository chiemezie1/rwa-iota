...
/// that represent unique real-world assets like real estate properties.
///
/// Only verified SPVs can create new asset NFTs, ensuring that each token
/// corresponds to a properly verified real-world asset.
